...
const Ion = () => {
    ...
    return (
      <mesh ref={iref} scale={[0.04,0.04,0.04]} rotation={[0, Math.PI,0.6]} position={[1.6,0,0]}>
    ...
    return(
        <div className="ION" id="3">
            ...
            <div className="ION-info" style={{zIndex: 30,position: 'relative',  width: '40vw', fontSize: '1.5vw'}}>
                <h2 style={{color: 'magenta'}}>Aboard the ION and experience being wasted in a new world!</h2>
